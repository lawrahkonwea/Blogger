...
RSpec.describe User, type: :model do
  ...
  it 'three_recent_posts' do
    subject.posts.create(title: 'Post 1', text: 'Post body', comments_counter: 0, likes_counter: 0)
    subject.posts.create(title: 'Post 2', text: 'Post body', comments_counter: 0, likes_counter: 0)
    subject.posts.create(title: 'Post 3', text: 'Post body', comments_counter: 0, likes_counter: 0)
